...
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_FFMediaPlayer_native_1SetGesture(JNIEnv *env, jclass clazz,
                                                                     jint   render_type,
...
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_FFMediaPlayer_native_1SetTouchLoc(JNIEnv *env, jclass clazz,
                                                                      jint   render_type,
                                                                      jfloat touch_x,
                                                                      jfloat touch_y) {
    switch (render_type)
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1CreateContext(JNIEnv *env,
                                                                               jobject thiz) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1DestroyContext(JNIEnv *env,
                                                                                jobject thiz) {
...
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1Init(JNIEnv *env, jobject thiz) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1UnInit(JNIEnv *env, jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1StartRecord(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jint recorder_type,
                                                                             jstring out_url,
                                                                             jint frame_width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1OnAudioData(JNIEnv *env,
                                                                             jobject thiz,
                                                                             jbyteArray data,
                                                                             jint size) {
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1StopRecord(JNIEnv *env,
                                                                            jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1OnPreviewFrame(JNIEnv *env,
                                                                                jobject thiz,
                                                                                jint format,
                                                                                jbyteArray data,
                                                                                jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1SetTransformMatrix(JNIEnv *env,
                                                                                    jobject thiz,
                                                                                    jfloat translate_x,
                                                                                    jfloat translate_y,
                                                                                    jfloat scale_x,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1OnSurfaceCreated(JNIEnv *env,
                                                                                  jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1OnSurfaceChanged(JNIEnv *env,
                                                                                  jobject thiz,
                                                                                  jint width,
                                                                                  jint height) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1OnDrawFrame(JNIEnv *env, jobject thiz) {
    MediaRecorderContext *pContext = MediaRecorderContext::GetContext(env, thiz);
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1SetFilterData(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jint index,
                                                                               jint format,
                                                                               jint width,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_example_leanffmpeg_media_MediaRecorderContext_native_1SetFragShader(JNIEnv *env,
                                                                               jobject thiz,
                                                                               jint index,
                                                                               jstring str) {
