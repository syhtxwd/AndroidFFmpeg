...
import com.example.leanffmpeg.media.MyGLSurfaceView;
...
import static com.example.leanffmpeg.media.FFMediaPlayer.MEDIA_PARAM_VIDEO_DURATION;
import static com.example.leanffmpeg.media.FFMediaPlayer.MEDIA_PARAM_VIDEO_HEIGHT;
import static com.example.leanffmpeg.media.FFMediaPlayer.MEDIA_PARAM_VIDEO_WIDTH;
import static com.example.leanffmpeg.media.FFMediaPlayer.MSG_DECODER_DONE;
import static com.example.leanffmpeg.media.FFMediaPlayer.MSG_DECODER_INIT_ERROR;
import static com.example.leanffmpeg.media.FFMediaPlayer.MSG_DECODER_READY;
import static com.example.leanffmpeg.media.FFMediaPlayer.MSG_DECODING_TIME;
import static com.example.leanffmpeg.media.FFMediaPlayer.MSG_REQUEST_RENDER;
import static com.example.leanffmpeg.media.FFMediaPlayer.VIDEO_GL_RENDER;
import static com.example.leanffmpeg.media.FFMediaPlayer.VIDEO_RENDER_OPENGL;
...
public class GLMediaPlayerActivity extends AppCompatActivity implements GLSurfaceView.Renderer, FFMediaPlayer.EventCallback, MyGLSurfaceView.OnGestureCallback{
    ...
    private String mVideoPath = Environment.getExternalStorageDirectory().getAbsolutePath() + "/sevenflowers/one_piece.mp4";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.e(TAG, "onCreate()4 called");
        mMediaPlayer.init(mVideoPath, VIDEO_RENDER_OPENGL, null);
        Log.e(TAG, "onCreate()5 called");
    }
